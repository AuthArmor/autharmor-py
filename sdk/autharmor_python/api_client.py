...
import autharmor_python.models
from autharmor_python import rest
from autharmor_python.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(autharmor_python.models, klass)
