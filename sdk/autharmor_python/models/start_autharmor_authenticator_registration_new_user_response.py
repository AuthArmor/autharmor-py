...
class StartAutharmorAuthenticatorRegistrationNewUserResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StartAutharmorAuthenticatorRegistrationNewUserResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StartAutharmorAuthenticatorRegistrationNewUserResponse:
        """Create an instance of StartAutharmorAuthenticatorRegistrationNewUserResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StartAutharmorAuthenticatorRegistrationNewUserResponse.parse_obj(obj)

        _obj = StartAutharmorAuthenticatorRegistrationNewUserResponse.parse_obj({
