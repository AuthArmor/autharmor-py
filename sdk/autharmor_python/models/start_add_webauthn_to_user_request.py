...
class StartAddWebauthnToUserRequest(BaseModel):
    """
    ...
    __properties = ["timeout_in_seconds", "webauthn_client_id", "attachment_type", "resident_key_requirement_type", "user_verification_requirement_type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StartAddWebauthnToUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StartAddWebauthnToUserRequest:
        """Create an instance of StartAddWebauthnToUserRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StartAddWebauthnToUserRequest.parse_obj(obj)

        _obj = StartAddWebauthnToUserRequest.parse_obj({
