...
class MobileDeviceDetails(BaseModel):
    """
    MobileDeviceDetails
    """
    platform: Optional[StrictStr] = None
    model: Optional[StrictStr] = None
    __properties = ["platform", "model"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MobileDeviceDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MobileDeviceDetails:
        """Create an instance of MobileDeviceDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MobileDeviceDetails.parse_obj(obj)

        _obj = MobileDeviceDetails.parse_obj({
