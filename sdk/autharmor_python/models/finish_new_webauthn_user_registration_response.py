...
class FinishNewWebauthnUserRegistrationResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FinishNewWebauthnUserRegistrationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FinishNewWebauthnUserRegistrationResponse:
        """Create an instance of FinishNewWebauthnUserRegistrationResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FinishNewWebauthnUserRegistrationResponse.parse_obj(obj)

        _obj = FinishNewWebauthnUserRegistrationResponse.parse_obj({
