...
class FinishAddWebauthnToUserRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FinishAddWebauthnToUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FinishAddWebauthnToUserRequest:
        """Create an instance of FinishAddWebauthnToUserRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FinishAddWebauthnToUserRequest.parse_obj(obj)

        _obj = FinishAddWebauthnToUserRequest.parse_obj({
