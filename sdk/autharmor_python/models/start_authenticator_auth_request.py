...
class StartAuthenticatorAuthRequest(BaseModel):
    """
    ...
    send_push: Optional[StrictBool] = None
    use_visual_verify: Optional[StrictBool] = None
    ...
    __properties = ["username", "user_id", "nonce", "send_push", "use_visual_verify", "timeout_in_seconds", "origin_location_data", "action_name", "short_msg", "ip_address", "user_agent"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StartAuthenticatorAuthRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StartAuthenticatorAuthRequest:
        """Create an instance of StartAuthenticatorAuthRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StartAuthenticatorAuthRequest.parse_obj(obj)

        _obj = StartAuthenticatorAuthRequest.parse_obj({
            "username": obj.get("username"),
            "user_id": obj.get("user_id"),
            "nonce": obj.get("nonce"),
            "send_push": obj.get("send_push"),
            "use_visual_verify": obj.get("use_visual_verify"),
