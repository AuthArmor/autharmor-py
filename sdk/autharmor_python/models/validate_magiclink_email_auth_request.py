...
class ValidateMagiclinkEmailAuthRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateMagiclinkEmailAuthRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateMagiclinkEmailAuthRequest:
        """Create an instance of ValidateMagiclinkEmailAuthRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateMagiclinkEmailAuthRequest.parse_obj(obj)

        _obj = ValidateMagiclinkEmailAuthRequest.parse_obj({
