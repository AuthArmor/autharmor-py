...
class ValidateWebauthnAuthRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateWebauthnAuthRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateWebauthnAuthRequest:
        """Create an instance of ValidateWebauthnAuthRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateWebauthnAuthRequest.parse_obj(obj)

        _obj = ValidateWebauthnAuthRequest.parse_obj({
