...
class AuthProfileDetails(BaseModel):
    """
    AuthProfileDetails
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuthProfileDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuthProfileDetails:
        """Create an instance of AuthProfileDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuthProfileDetails.parse_obj(obj)

        _obj = AuthProfileDetails.parse_obj({
