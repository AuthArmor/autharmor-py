...
class ValidateAutharmorAutenticatorRegistrationRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ValidateAutharmorAutenticatorRegistrationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ValidateAutharmorAutenticatorRegistrationRequest:
        """Create an instance of ValidateAutharmorAutenticatorRegistrationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ValidateAutharmorAutenticatorRegistrationRequest.parse_obj(obj)

        _obj = ValidateAutharmorAutenticatorRegistrationRequest.parse_obj({
