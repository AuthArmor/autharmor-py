...
class UsersResponsePageInfo(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UsersResponsePageInfo:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UsersResponsePageInfo:
        """Create an instance of UsersResponsePageInfo from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UsersResponsePageInfo.parse_obj(obj)

        _obj = UsersResponsePageInfo.parse_obj({
