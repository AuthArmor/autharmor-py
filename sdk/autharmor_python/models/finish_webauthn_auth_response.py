...
class FinishWebauthnAuthResponse(BaseModel):
    """
    ...
    __properties = ["auth_validation_token", "user_id", "auth_request_id", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FinishWebauthnAuthResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FinishWebauthnAuthResponse:
        """Create an instance of FinishWebauthnAuthResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FinishWebauthnAuthResponse.parse_obj(obj)

        _obj = FinishWebauthnAuthResponse.parse_obj({
