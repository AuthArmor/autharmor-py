...
from autharmor_python.models.validate_auth_response import ValidateAuthResponse  # noqa: E501

class TestValidateAuthResponse(unittest.TestCase):
    """ValidateAuthResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidateAuthResponse:
        """Test ValidateAuthResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidateAuthResponse`
        """
        model = ValidateAuthResponse()  # noqa: E501
        if include_optional:
            return ValidateAuthResponse(
                auth_request_status_id = 56,
                auth_request_status_name = '',
                validate_auth_response_details = autharmor_python.models.validate_auth_response_details.validate_auth_response_details(
                    auth_history_id = '', 
                    result_code = 56, 
                    result_message = '', 
                    authorized = True, 
    ...
    def testValidateAuthResponse(self):
        """Test ValidateAuthResponse"""
